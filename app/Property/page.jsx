...
const HomesForYou = () => {
  ...
  const fetchProperties = async () => {
    try {
      ...
      setProperties(response.data.properties); // Adjust based on your API
    } catch (error) {
  ...
  // Temporary mocked data for layout testing
  const mockData = [
    {
      id: 1,
      image: "/h1.jpg",
  ...
  return (
    <>
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-100 to-purple-100 flex items-center justify-center py-12 pt-32 px-4">
       
      <div
        style={{
          backgroundImage:
            "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.7)), url('https://media.istockphoto.com/id/1292569664/photo/3d-rendering-of-modern-house-in-luxurious-style-in-night.jpg?s=612x612&w=0&k=20&c=5buEu1uKSz3zOfvYERbS7vGnHJGhlxDsOQVTMdyMYD4=')",
      ...
      >
        ...
        <p className="text-lg md:text-xl font-serif max-w-2xl bg-white/80 text-gray-900 p-6 rounded-xl shadow-lg mb-4 text-center">
          Discover a curated selection of beautiful homes and investment opportunities. Whether you’re searching for a cozy family house, a modern apartment, or a luxurious villa, we help you find the perfect property to match your dreams and lifestyle.
        </p>
        <a
          href="#"
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-6">
        {mockData.map((home) => (
          ...
          >
            ...
            <div className="p-4">
              <h3 className="text-md font-semibold text-gray-800">{home.title}</h3>
              <p className="text-sm text-gray-500">{home.address}</p>
              <p className="text-red-500 font-bold text-lg mt-2">{home.price}</p>
